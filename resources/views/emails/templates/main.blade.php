...
{{--                        <img class="mobile_only mobile-logo" border="0" src="{{url('/assets/images/logo-full.png')}}"--}}
{{--                             alt="{{ $senderName or '' }}"/>--}}
{{--                    </td>--}}
{{--                </tr>--}}
                <tr class="mobile_only">
...
{{--                                    <img border="0" src="{{url('/assets/images/logo-full.png')}}"--}}
{{--                                         alt="{{ $senderName or ''}}" width="{{ $logo['width'] }}"--}}
{{--                                         height="{{ $logo['height'] }}"/>--}}
{{--                                </td>--}}
{{--                                <td class="w30" width="30"></td>--}}
{{--                            </tr>--}}
...
{{--                                            @if (isset($facebook))--}}
{{--                                                <td><a href="http://facebook.com/{{ $facebook }}">--}}
...
{{--                </tr>--}}
{{--                <tr>--}}
{{--                    <td class="w640" width="640" align="center" style="padding:30px">--}}
{{--                        <table align="center">--}}
{{--                            <tr>--}}
{{--                                <td>--}}
{{--                                    <a href="{!! env('DOWNLOAD_GOOGLE_PLAY', '') !!}">--}}
{{--                                        <img border="0" src="{{url('/assets/images/google-play.png')}}"--}}
{{--                                             alt="Google Play Store" style="max-width:190px"/>--}}
{{--                                    </a>--}}
{{--                                </td>--}}
{{--                                <td>--}}
{{--                                    <a href="{!! env('DOWNLOAD_APPLE_STORE', '') !!}">--}}
{{--                                        <img border="0" src="{{url('/assets/images/apple-store.png')}}"--}}
{{--                                             alt="Apple App store" style="max-width:190px"/>--}}
{{--                                    </a>--}}
{{--                                </td>--}}
{{--                            </tr>--}}
{{--                        </table>--}}
