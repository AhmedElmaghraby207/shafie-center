                ...
                columns: [
                        ...
                        @if(session()->get('user_admin')->can('branch-edit') || session()->get('user_admin')->can('branch-delete'))
                    {
                        ...
                        "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                            ...
                            $(nTd).append(
                                "<a href='{{url('shafie-center/dashboard/branch/')}}/" + oData.id + "/edit' class='btn btn-warning btn-sm' title='@lang('main.edit_button')'><i class='fa fa-edit'></i></a>  "
                            );
                            @endif
                            @if(session()->get('user_admin')->can('branch-delete'))
                            $(nTd).append(
                                "<a href='javascript:' url='{{url('shafie-center/dashboard/branch/')}}/" + oData.id + "/delete' onclick='destroy(" + oData.id + ")' id='delete_" + oData.id + "' class='btn btn-danger btn-sm' title='@lang('main.delete_button')'><i class='fa fa-trash-alt'></i></a>"
                            );
                            @endif
                        }
                    }
